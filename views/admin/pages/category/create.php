        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    <form role="form" class="text-start p-4" autocomplete="off" method="post" action="<?= url('admin/category/handleCreate') ?>" enctype="multipart/form-data">
                        <label>Tiêu đề <span class="text-danger">*</span></label>
                        <div class="input-group input-group-outline mb-3">
                            <input type="text" name="title" placeholder="Tiêu đề" class="form-control <?= isset($errors['title']) ? 'is-invalid' : '' ?>" value="<?= isset($errors['form_data']) ? $errors['form_data']['title'] : '' ?>">
